...
of web applications using [**Serenity/JS**](https://serenity-js.org), [**Jasmine**](https://jasmine.github.io/), and [**Protractor**](http://www.protractortest.org/),
...
- [Serenity BDD living documentation](https://serenity-js.github.io/serenity-js-jasmine-protractor-template/)

## Features

- Pre-configured **Serenity/JS** + **Jasmine** + **Protractor** + **TypeScript** setup
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-jasmine-protractor-template)
...
npm test -- --specs=spec/serenity-js_website.spec.ts

# Run with specific suite
# Update protractor.conf.js to configure suites and run with --suite flag
```
...
**Key files:**
- `spec/*.spec.ts` - Jasmine test specifications
...
- [Using Serenity/JS with Jasmine](https://serenity-js.org/handbook/test-runners/jasmine/)
- [Using Serenity/JS with Protractor](https://serenity-js.org/handbook/integration/protractor/)
